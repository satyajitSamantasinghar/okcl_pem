...
const RAQuarterlyEvaluationPage = () => {
    ...
    return (
        <div className="fade-in">
            <div className="page-header">
                <h1>Quarterly Evaluation</h1>
                <p>View quarterly performance reports and provide quarterly remarks</p>
            </div>
            ...
            {evaluations.length === 0 ? (
                <div className="qtr-empty">
                    ...
                    <h3>No Quarterly Reports Available</h3>
                    <p>
                        Quarterly reports are auto-generated once all 3 months of {quarter.replace('-', ' ')} have been evaluated.
                    </p>
                </div>
            ) : (
                <div className="qtr-reports-grid">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{ margin: '8px 0 12px' }}>
                                    <div style={{
                                        height: 5, background: 'var(--border-default)',
                                ...
                                <div className="qtr-report-footer">
                                    {ev.hasRemarks ? (
                                        <span className="qtr-remarks-badge has-remarks">
                                            <FiCheckCircle size={11} /> Remarks added
                                        </span>
                                    ) : (
                                        <span className="qtr-remarks-badge needs-remarks">
                                            <FiAlertCircle size={11} /> Remarks pending
                                        </span>
                                    )}
                                    <span className="qtr-report-view-hint">
                                ...
                                {!ev.hasRemarks && (
                                    <div className="qtr-remarks-prompt">
                                        <FiEdit3 size={11} /> Add quarterly remarks
                                    </div>
                                )}
                            </div>
                        );
