...
function getEffectivePlanAch(achObj, planCount) {
    if (!achObj) return null;
    const pa = achObj.planAchievements;
    ...
    if (achObj.achievementDetails) {
        const parsed = parseLegacyPlanAch(achObj.achievementDetails, planCount);
